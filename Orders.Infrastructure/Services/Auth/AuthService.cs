...
namespace Orders.Infrastructure.Services.Auth
{
    public class AuthService : IAuthService
    {
        ...
        public AuthService(OrdersDbContext db, UserManager<User> userManger, IMapper mapper,IOptions<JwtOptions> options)
        {
            _db = db;
            _mapper = mapper;
        ...
        public async Task<LoginResponseViewModel> Login(LoginDto dto)
        {
            ...
            response.AcessToken = await GenerateAccessToken(user);
